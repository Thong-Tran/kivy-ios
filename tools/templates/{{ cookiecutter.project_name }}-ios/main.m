...
int main(int argc, char *argv[]) {
    ...
    NSString *python_path = [NSString stringWithFormat:@"PYTHONPATH=%@:%@/lib/python3.7/:%@/lib/python3.7/site-packages:%@/YourApp", resourcePath, resourcePath, resourcePath, resourcePath, nil];
